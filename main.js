...
function showDetail(data) {
    ...
    for (let i = 1; i < 15; i++) {
        if (data.drinks[0][`strIngredient${i}`] !== null) {
            ...
            let ale= document.createElement('span')
            let ale2 = document.createElement('span')
            ale.innerHTML = data.drinks[0][`strIngredient${i}`]
            ale.style.marginRight = '10px'
            ale2.innerHTML = data.drinks[0][`strMeasure${i}`]
            li.append(ale)
